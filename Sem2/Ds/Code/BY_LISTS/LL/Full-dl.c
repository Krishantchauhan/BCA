...
void main()
{
	...
	while(1)
	{
	  ...
	  switch(ch)
	  {
		 ...
		 display();
		 break;
		 case 3:printf("Enter the data to Insert at the Begning\n");
		 scanf("%d",&a);
		 ins_beg(a);
		 break;
		 case 4:printf("Enter the data to Insert at the End\n");
			 scanf("%d",&y);
			 insert_last(y);
			 break;
		 case  5:printf("Enter the postion \n");
			 scanf("%d",&pos);
		 ...
		 case 7:del_end();
	  	break;
			case 8:printf("Enter the postion \n");
 			 scanf("%d",&po);
			del(po);
			break;
		 case 9:exit(1);
